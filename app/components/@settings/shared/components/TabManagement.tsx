...
const BetaLabel = () => (
  <span className="px-1.5 py-0.5 text-[10px] rounded-full bg-teal-500/10 text-teal-500 font-medium">BETA</span>
);
              ...
              <div className="flex items-start gap-4 p-4">
                <motion.div
                  className={classNames(
                    ...
                    'transition-all duration-200',
                    tab.visible ? 'text-teal-500' : 'text-bolt-elements-textSecondary',
                  )}
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <Switch
                      ...
                      className={classNames(
                        ...
                        tab.visible ? 'bg-teal-500' : 'bg-bolt-elements-background-depth-4',
                        {
