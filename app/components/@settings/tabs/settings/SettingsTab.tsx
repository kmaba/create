              ...
              <button
                ...
                className={classNames(
                  ...
                  settings.theme === theme
                    ? 'bg-teal-500 text-white hover:bg-teal-600 dark:bg-teal-500 dark:text-white dark:hover:bg-teal-600'
                    : 'bg-bolt-elements-hover dark:bg-[#1A1A1A] text-bolt-elements-textSecondary hover:bg-teal-500/10 hover:text-teal-500 dark:hover:bg-teal-500/20 dark:text-bolt-elements-textPrimary dark:hover:text-teal-500',
                )}
              >
                <div
                  className={`w-4 h-4 ${
      ...
      >
        ...
        <div className="space-y-2">
          {Object.entries(useStore(shortcutsStore)).map(([name, shortcut]) => (
            <div
              key={name}
              className="flex items-center justify-between p-2 rounded-lg bg-[#FAFAFA] dark:bg-[#1A1A1A] hover:bg-teal-50 dark:hover:bg-teal-500/10 transition-colors"
            >
