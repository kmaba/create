    ...
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <CollapsibleTrigger
        className={classNames(
          ...
          'hover:bg-teal-50/50 dark:hover:bg-[#1a1a1a]',
  ...
  return (
    <div className="flex flex-col gap-6 max-w-7xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-teal-500/30 transition-all duration-200">
          <div className="flex items-center gap-2">
            <div className="i-ph:robot text-teal-500 w-4 h-4" />
          ...
          {ollamaStatus.models && ollamaStatus.models.length > 0 && (
            <div className="mt-3 space-y-1 border-t border-[#E5E5E5] dark:border-[#1A1A1A] pt-2">
              <div className="text-xs font-medium text-bolt-elements-textSecondary flex items-center gap-1.5">
                <div className="i-ph:cube-duotone w-3.5 h-3.5 text-teal-500" />
                Installed Models
              </div>
              {ollamaStatus.models.map((model) => (
                <div key={model.name} className="text-xs text-bolt-elements-textSecondary flex items-center gap-2 pl-5">
                  <div className="i-ph:cube w-3 h-3 text-teal-500/70" />
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-teal-500/30 transition-all duration-200">
          <div className="flex items-center gap-2">
            <div className="i-ph:cpu text-teal-500 w-4 h-4" />
          ...
          />
          <div className="text-xs text-bolt-elements-textSecondary mt-2 flex items-center gap-1.5">
            <div className="i-ph:info w-3.5 h-3.5 text-teal-500" />
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-teal-500/30 transition-all duration-200">
          <div className="flex items-center gap-2">
            <div className="i-ph:timer text-teal-500 w-4 h-4" />
          ...
          <div className="text-xs text-bolt-elements-textSecondary mt-2 flex items-center gap-1.5">
            <div className="i-ph:code w-3.5 h-3.5 text-teal-500" />
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-teal-500/30 transition-all duration-200">
          <div className="flex items-center gap-2">
            <div className="i-ph:wifi-high text-teal-500 w-4 h-4" />
          ...
          <div className="text-xs text-bolt-elements-textSecondary mt-2 flex items-center gap-1.5">
            <div className="i-ph:activity w-3.5 h-3.5 text-teal-500" />
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-teal-500/30 transition-all duration-200">
          <div className="flex items-center gap-2">
            <div className="i-ph:warning-octagon text-teal-500 w-4 h-4" />
      ...
      >
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              <div className="i-ph:cpu text-teal-500 w-5 h-5" />
      ...
      >
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              <div className="i-ph:chart-line text-teal-500 w-5 h-5" />
