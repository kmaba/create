                  ...
                  <div className="mt-4 space-y-2">
                    ...
                    <div className="space-y-2 text-sm text-[#111111] dark:text-white">
                      ...
                      {stats.hasPackageJson && (
                        <div className="flex items-center gap-2">
                          <span className="i-ph:package text-teal-500 w-4 h-4" />
                          <span>Has package.json</span>
                        </div>
                      )}
                      {stats.hasDependencies && (
                        <div className="flex items-center gap-2">
                          <span className="i-ph:tree-structure text-teal-500 w-4 h-4" />
            ...
            {activeTab === 'url' ? (
              <div className="space-y-4">
                ...
                <button
                  ...
                  disabled={!customUrl}
                  className="w-full h-10 px-4 py-2 rounded-lg bg-teal-500 text-white hover:bg-teal-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center gap-2 justify-center"
                >
                  Import Repository
                </button>
              </div>
                  ...
                  {selectedRepository ? (
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <button
                          onClick={handleImport}
                          className="w-full h-10 px-4 py-2 rounded-lg bg-teal-500 text-white hover:bg-teal-600 transition-all duration-200 flex items-center gap-2 justify-center"
                        >
...
function RepositoryCard({ repo, onSelect }: { repo: GitHubRepoInfo; onSelect: () => void }) {
  return (
    <div className="p-4 rounded-lg bg-[#F5F5F5] dark:bg-[#252525] border border-[#E5E5E5] dark:border-[#333333] hover:border-teal-500/50 transition-colors">
      <div className="flex items-center justify-between mb-2">
        ...
        <button
          onClick={onSelect}
          className="px-4 py-2 h-10 rounded-lg bg-teal-500 text-white hover:bg-teal-600 transition-all duration-200 flex items-center gap-2 min-w-[120px] justify-center"
        >
